...
class Util
{
    ...
    public static function navyUnpack($lv)
    {
        ...
        // 旧フォーマット（5ビット島ID）と新フォーマット（10ビット島ID）の両方に対応
        //
        // 旧フォーマット（20ビット）:
        //  5bit 島ID (0-31)
        //  3bit 種類
    ...
    public static function navyPack($id, $kind, $hp, $exp, $flag)
    {
        ...
        // 25  合計
        //
        // 注：navyUnpack()は旧フォーマット（5ビット島ID）も読めるが、
        //     navyPack()は常に新フォーマット（10ビット島ID）で保存する。
        //     これにより、データは段階的に新フォーマットへ移行される。
