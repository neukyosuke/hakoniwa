...
class Hako extends File
{
    ...
    public function landString($l, $lv, $x, $y, $mode, $comStr = ''): void
    {
        ...
        echo "<img src=\"{$init->imgDir}/{$image}\" width=\"40\" height=\"40\" alt=\"{$point} {$naviTitle}\" onMouseOver=\"Navi({$naviPos},'{$init->imgDir}/{$image}', '{$naviTitle}', '{$point}', '{$naviText}', {$naviExp});\" onMouseOut=\"NaviClose(); return false\">";
...
class HakoEdit extends File
{
    ...
    public function landString($l, $lv, $x, $y, $mode, $comStr): void
    {
        ...
        echo "<img src=\"{$init->imgDir}/{$image}\" width=\"40\" height=\"40\" alt=\"{$point} {$naviTitle} {$comStr}\" onMouseOver=\"Navi({$naviPos}, '{$init->imgDir}/{$image}', '{$naviTitle}', '{$point}', '{$naviText}', {$naviExp});\" onMouseOut=\"NaviClose(); return false\">";
