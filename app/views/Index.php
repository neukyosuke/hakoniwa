...
<div id="HistoryLog">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<h4>新機能</h4>
			<ul>
				<li><strong>季節システムの導入</strong>
					<ul>
						<li>ターン進行に応じて春・夏・秋・冬の4つの季節が循環するようになりました</li>
						<li>春の季節には農場の収入が20%増加します</li>
					</ul>
				</li>
				<li><strong>新たな災害：干ばつ</strong>
					<ul>
						<li>低確率で干ばつが発生するようになりました</li>
						<li>干ばつが発生すると3ターンの間、農場の生産量が50%減少します</li>
						<li>季節による恩恵と組み合わせて、より戦略的な農業経営が求められます</li>
					</ul>
				</li>
				<li><strong>マップサイズの拡張</strong>
					<ul>
						<li>島のマップサイズが20×20から24×24に拡大されました</li>
						<li>より広い土地で開発が可能になり、戦略の幅が広がります</li>
						<li>既存の島も安全に拡張できるよう、移行ツールを用意しています</li>
					</ul>
				</li>
			</ul>
			<h4>改善・修正</h4>
