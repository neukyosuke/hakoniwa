...
class InitDefault
{
    ...
    public $monsterBHP = [
        ...
        5, 6, 6, 7, 8,
        5, 99,
        15, 20, 18  // NEW: 古代龍15, メカゴジラ20, 深海クラーケン18
    ];
    // 体力の幅
    public $monsterDHP = [
        0, 2, 1, 2, 1,
        ...
        2, 2, 2, 2, 1,
        0, 0,
        3, 2, 3  // NEW: 古代龍3, メカゴジラ2, 深海クラーケン3
    ];
    // 特殊能力概要：(ビット和フラグ)
    // 0x00000 特になし
    ...
    // 0x20000 分裂する
    // 0x80000 森を増やす（古代龍）
    // 0x100000 工場を破壊し資金を奪う（メカゴジラ）
    // 0x200000 海底都市を攻撃（深海クラーケン）
    public $monsterSpecial = [
        ...
        0x2121, 0x42,
        0x80001, 0x100041, 0x200200  // NEW: 古代龍(森を増やす+足速い), メカゴジラ(工場破壊+ワープ), 深海クラーケン(海底都市攻撃+飛行)
    ];
    ...
    public $monsterExp = [
        ...
        43, 50, 50, 48, 60,
        100, 200,
        80, 100, 90  // NEW: 古代龍80, メカゴジラ100, 深海クラーケン90
    ];
    // 死骸の値段
    public $monsterValue = [
        ...
        10000, 50000,
        8000, 12000, 10000  // NEW: 古代龍8000, メカゴジラ12000, 深海クラーケン10000
    ];
    ...
    public $ItemName = [
        ...
        '木材',
        '古代の盾', '黄金の鍬', '青い宝石', 'タイムカプセル', '魔法の杖'  // NEW: アイテム5種追加
    ];
    ...
    ********************/
    ...
    public $landOnsen     = 44; // 温泉 - NEW
    public $landLab       = 45; // 研究所 - NEW
    public $landUniv      = 46; // 大学 - NEW
    public $landSpaceport = 47; // 宇宙港 - NEW
    public $landResort    = 48; // リゾート - NEW
